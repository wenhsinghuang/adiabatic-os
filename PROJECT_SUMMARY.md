...
大多數 AI 產品的主角是 **agent**——你圍著 agent 轉，幫它設定 skill、給它權限、讓它去各個平台代表你。你的身份在系統裡是碎片化的：一部分在某個對話裡、一部分在 agent 的 memory vault 裡、一部分在各個 connector 的資料裡。Agent 是中心，你是它的 context。

**Adiabatic 是反過來的：你是中心，AI 是來幫你的 worker。**

D0/D1/D2 不是在存「agent 做了什麼」，是在存**你經歷了什麼、想了什麼、什麼模式在你的生活中反覆出現**。Promote 不是資料庫操作，是你對自己的某個認知穩定到可以結晶了。Optimizer 不是在優化系統效能，是在幫你看見自己的模式。

這也是為什麼取名叫 **Adiabatic**——絕熱過程，能量不流失到外部。你的資料、你的模式、你的結構全部留在系統內部，不散逸到各種第三方工具裡。

|  | Agent-centric 產品 | Adiabatic OS |
|--|-------------------|--------------|
| **主角** | Agent（你是它的 context） | 你（AI 是你的 worker） |
| **方向** | 向外：幫你做事、跟世界互動、代表你出去 | 向內：幫你理解自己、累積自己、讓知識體系自然成長 |
| **資料存的是** | Agent 做了什麼 | 你經歷了什麼、想了什麼 |
| **Promote 意味著** | 資料庫操作 | 一個認知穩定到可以結晶 |
| **Optimizer 在做的** | 優化系統效能 | 幫你看見自己的模式 |
| **競品** | Siri、Google Assistant、AI agent 平台 | Obsidian、Notion、日記本——加上「系統主動幫你整理」的能力 |

所以 Adiabatic 不是技術突破，是**一種生活方式的工具化**。這種東西很難用 feature list 說服人，但用過的人會離不開。
